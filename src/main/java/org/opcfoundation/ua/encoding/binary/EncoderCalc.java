...
import org.opcfoundation.ua.encoding.utils.*;
    ...
    public void putNodeId(String fieldName, NodeId v) {
        ...
        if (v.getIdType() == IdType.Numeric) {
            ...
            if (i.compareTo(UnsignedByte.MAX_VALUE) <= 0 && v.getNamespaceIndex() == 0) {
                length += 2;
            } else if (i.compareTo(UnsignedShort.MAX_VALUE) <= 0 && v.getNamespaceIndex() < 256) {
                length += 4;
            } else {
                length += 7;
            }
        } else if (v.getIdType() == IdType.String) {
            length += 3;
            putString(null, (String) v.getValue());
        } else if (v.getIdType() == IdType.Opaque) {
            length += 3;
            putByteString(null, (ByteString) v.getValue());
        } else if (v.getIdType() == IdType.Guid) {
            length += 19;
        }
    }
...
//		if (v.getServerIndex()!=null) upperBits |= 0x40;
    ...
    public void putObject(String fieldName, Class<?> c, Object o) throws EncodingException {
        ...
        if (array)
            ...
            ctx.getEncodeableSerializer().calcEncodeable((Class<? extends IEncodeable>) scalarClass, (IEncodeable) o, this);
    }
    ...
    public void putScalar(String fieldName, int builtinType, Object o) throws EncodingException {
        switch (builtinType) {
            case 1:
                putBoolean(null, (Boolean) o);
                break;
            case 2:
                putSByte(null, (Byte) o);
                break;
            case 3:
                putByte(null, (UnsignedByte) o);
                break;
            case 4:
                putInt16(null, (Short) o);
                break;
            case 5:
                putUInt16(null, (UnsignedShort) o);
                break;
            case 6:
                putInt32(null, (Integer) o);
                break;
            case 7:
                putUInt32(null, (UnsignedInteger) o);
                break;
            case 8:
                putInt64(null, (Long) o);
                break;
            case 9:
                putUInt64(null, (UnsignedLong) o);
                break;
            case 10:
                putFloat(null, (Float) o);
                break;
            case 11:
                putDouble(null, (Double) o);
                break;
            case 12:
                putString(null, (String) o);
                break;
            case 13:
                putDateTime(null, (DateTime) o);
                break;
            case 14:
                putGuid(null, (UUID) o);
                break;
            ...
            case 16:
                ...
                break;
            case 17:
                putNodeId(null, (NodeId) o);
                break;
            case 18:
                putExpandedNodeId(null, (ExpandedNodeId) o);
                break;
            case 19:
                putStatusCode(null, (StatusCode) o);
                break;
            case 20:
                putQualifiedName(null, (QualifiedName) o);
                break;
            case 21:
                putLocalizedText(null, (LocalizedText) o);
                break;
            case 22: {
            ...
            case 23:
                putDataValue(null, (DataValue) o);
                break;
            case 24:
                putVariant(null, (Variant) o);
                break;
            case 25:
                putDiagnosticInfo(null, (DiagnosticInfo) o);
                break;
            default:
                throw new EncodingException("cannot encode builtin type " + builtinType);
        }
    }
    ...
    public void putArray(String fieldName, int builtinType, Object o) throws EncodingException {
        switch (builtinType) {
            case 1:
                putBooleanArray(null, (Boolean[]) o);
                break;
            case 2:
                putSByteArray(null, (Byte[]) o);
                break;
            case 3:
                putByteArray(null, (UnsignedByte[]) o);
                break;
            case 4:
                putInt16Array(null, (Short[]) o);
                break;
            case 5:
                putUInt16Array(null, (UnsignedShort[]) o);
                break;
            case 6:
                putInt32Array(null, (Integer[]) o);
                break;
            case 7:
                putUInt32Array(null, (UnsignedInteger[]) o);
                break;
            case 8:
                putInt64Array(null, (Long[]) o);
                break;
            case 9:
                putUInt64Array(null, (UnsignedLong[]) o);
                break;
            case 10:
                putFloatArray(null, (Float[]) o);
                break;
            case 11:
                putDoubleArray(null, (Double[]) o);
                break;
            case 12:
                putStringArray(null, (String[]) o);
                break;
            case 13:
                putDateTimeArray(null, (DateTime[]) o);
                break;
            case 14:
                putGuidArray(null, (UUID[]) o);
                break;
            case 15:
                putByteStringArray(null, (ByteString[]) o);
                break;
            case 16:
                putXmlElementArray(null, (XmlElement[]) o);
                break;
            case 17:
                putNodeIdArray(null, (NodeId[]) o);
                break;
            case 18:
                putExpandedNodeIdArray(null, (ExpandedNodeId[]) o);
                break;
            case 19:
                putStatusCodeArray(null, (StatusCode[]) o);
                break;
            case 20:
                putQualifiedNameArray(null, (QualifiedName[]) o);
                break;
            case 21:
                putLocalizedTextArray(null, (LocalizedText[]) o);
                break;
            case 22: {
            ...
            case 23:
                putDataValueArray(null, (DataValue[]) o);
                break;
            case 24:
                putVariantArray(null, (Variant[]) o);
                break;
            case 25:
                putDiagnosticInfoArray(null, (DiagnosticInfo[]) o);
                break;
            default:
                throw new EncodingException("cannot encode builtin type " + builtinType);
        }
    ...
    public void putEncodeableArray(String fieldName, Class<? extends IEncodeable> clazz, Object array) throws ArrayIndexOutOfBoundsException, EncodingException, IllegalArgumentException {
        ...
        length += 4;
        for (int i = 0; i < len; i++)
            ctx.getEncodeableSerializer().calcEncodeable(clazz, (IEncodeable) Array.get(array, i), this);
    }
    ...
    public void putEncodeable(String fieldName, IEncodeable s) throws EncodingException {
        ...
        ctx.getEncodeableSerializer().calcEncodeable(clazz, s, this);
    }
     ...
     * @throws EncodingException
     */
    void putEncodeable(IEncodeable s, EncodeableDesc si) throws EncodingException {
        try {
