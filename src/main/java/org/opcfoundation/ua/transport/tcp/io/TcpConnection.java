...
import org.opcfoundation.ua.transport.tcp.impl.*;
...
public class TcpConnection implements IConnection {
     ...
     * socket (depending on the operating system) is used.
     *
     * @param sendBufferSize the new size in bytes
     */
    ...
    public void initialize(InetSocketAddress addr, TransportChannelSettings settings, EncoderContext ctx) throws ServiceResultException {
        ...
        try {
            this.addr = addr;
            this.endpointConfiguration = EndpointConfiguration.newInstanceFrom(settings.getConfiguration());
            this.endpointDescription = EndpointDescription.newInstanceFrom(settings.getDescription());
