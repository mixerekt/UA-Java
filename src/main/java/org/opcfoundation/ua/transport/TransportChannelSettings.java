...
public class TransportChannelSettings implements Cloneable {
    ...
    @SneakyThrows
    public static TransportChannelSettings newInstanceFrom(TransportChannelSettings source) {
        Objects.requireNonNull(source);

        return (TransportChannelSettings) source.clone();
    }
    ...
    public TransportChannelSettings(
            ...
            NamespaceTable namespaceUris) throws RuntimeServiceResultException {
        super();
    ...
    public TransportChannelSettings(
            ...
            X509HostnameVerifier hostnameVerifier) throws RuntimeServiceResultException {
        super();
        this.configuration = configuration;
        this.description = description;
    ...
    public void readFrom(TransportChannelSettings tcs) {
        if (tcs.description != null) description = EndpointDescription.newInstanceFrom(tcs.description);
        if (tcs.configuration != null) configuration = EndpointConfiguration.newInstanceFrom(tcs.configuration);
