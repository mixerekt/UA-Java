...
public class NamespaceTable extends UriTable {
     ...
     */
    public static final String OPCUA_NAMESPACE = "http://opcfoundation.org/UA/";

    private static final NamespaceTable defaultInstance = NamespaceTable.createFromArray(new String[]{NamespaceTable.OPCUA_NAMESPACE});
     ...
     * table
     *
     * @param expandedNodeId the expanded node ID
     * @return The respective NodeId
     * @throws org.opcfoundation.ua.common.ServiceResultException if there is no entry for the namespaceUri used in the
     *                                                            expandedNodeId
     */
